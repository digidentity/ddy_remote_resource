  ...
  module Base
    ...
    module ClassMethods
      ...
      def get(attributes = {}, connection_options = {})
        ...
        response = connection.get determined_request_url(connection_options), body: attributes, headers: connection_options[:default_headers] || self.connection_options.headers.merge(connection_options[:headers])
        if response.success?
